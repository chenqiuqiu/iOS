...
/** connects to the specified MQTT server
 ...
 as not all connection parameters are supported, use connect
 */
...
/** connects to the specified MQTT server
 ...
 see connectToHost for description
 as not all connection parameters are supported, use connect
...
/** for mqttio-OBJC backward compatibility
 ...
 @param port see connectToHost for description
d as not all connection parameters are supported, use connect
 */
